        ...
        if ($fileSize > 0 && $fileSize < 500000) {
            ...
            if (in_array($mime, ['image/jpeg', 'image/png'])) {
                ...
                if (move_uploaded_file($pictureFile, $fileDestination)) {
                    ...
                    throw new Exception("There was an error uploading your picture.");
                }
            } else {
                throw new Exception("Invalid file type. Only JPG and PNG are allowed.");
            }
        } else {
            throw new Exception("File size is either too large or missing.");
        }
   ...
   */
        ...
        if (!empty($subjectName) && !empty($subjectPIN)) {
            ...
            if ($stmt->execute()) {
                ...
                throw new Exception("Professor or subject registration failed.");
            }
        } else {
            throw new Exception("Missing subject name or PIN.");
        }
    } catch (Exception $e) {
